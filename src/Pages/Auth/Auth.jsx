        ...
        <section className="min-h-screen flex flex-col items-center justify-center">
            ...
            <div className="w-full lg:w-1/4 bg-white dark:bg-dark-930 rounded-2xl py-9 px-12.5 dark:text-white">
                ...
                <div className="pb-5 border-b border-gray-300/30 font-YekanBakh-Bold">
                    ...
                    <span className="text-sm text-gray-300 dark:text-gray-210">شماره موبایل یا ایمیل خود را وارد کنید</span>
                </div>
                {/*<!-- ! -------------------- Form -------------------- ! -->*/}
                <form className="mt-5">
                    ...
                    <p className="flex items-center gap-1 mt-4 font-YekanBakh-Medium text-xs text-gray-600 dark:text-gray-50">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-blue-600" viewBox="0 0 256 256">
                            ...
                            <path d="M173.66 98.34a8 8 0 0 1 0 11.32l-56 56a8 8 0 0 1-11.32 0l-24-24a8 8 0 0 1 11.32-11.32L112 148.69l50.34-50.35a8 8 0 0 1 11.32 0M232 128A104 104 0 1 1 128 24a104.11 104.11 0 0 1 104 104m-16 0a88 88 0 1 0-88 88 88.1 88.1 0 0 0 88-88"></path>
                        </svg>
                        ورود/ثبت‌نام شما به معنای پذیرش
                        <Link to="/" className="inline-block font-YekanBakh-Bold text-blue-700 underline"> قوانین</Link>
                        میباشد
                    </p>
                    <button onClick={checkUserHandler} className="w-full h-11 flex-center border text-white border-blue-700 dark:hover:bg-transparent bg-blue-700 hover:text-blue-700 hover:bg-white rounded-lg mt-6 cursor-pointer font-YekanBakh-Bold transition-all">ادامه</button>
                </form>
            </div>
            {/*<!-- ! -------------------- Copy Right Text -------------------- ! -->*/}
            <span className="flex items-center gap-1 mt-4 text-gray-400 text-xs">
                ...
                <svg  width="12" height="12" fill="currentColor" viewBox="0 0 256 256">
                     <path d="M128 24a104 104 0 1 0 104 104A104.11 104.11 0 0 0 128 24m0 192a88 88 0 1 1 88-88 88.1 88.1 0 0 1-88 88m-32-88a32 32 0 0 0 57.6 19.2 8 8 0 0 1 12.8 9.61 48 48 0 1 1 0-57.62 8 8 0 0 1-12.8 9.61A32 32 0 0 0 96 128"></path>
                  </svg>
            </span>
