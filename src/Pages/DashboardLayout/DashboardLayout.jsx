            ...
            <aside className="col-span-2 pt-11 flex flex-col min-h-screen pb-3">
                ...
                <div className="mt-16">
                   <ul className="space-y-2 text-lg">
                       ...
                       <li className="px-4">
                           <Link to="/dashboard/missions" className={`flex items-center gap-x-4 ${location.pathname.includes('missions') ? 'text-blue-700 bg-blue-700/10' : 'text-white bg-transparent hover:text-blue-450'}  transition-all px-4 py-3 rounded-3xl`}>
