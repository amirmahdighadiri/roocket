        ...
        <div className="rounded-2xl bg-white dark:bg-dark-body-100 p-4 lg:px-11 lg:py-8">
            ...
            <from className="space-y-5">
                ...
                <div className="relative">
                    ...
                    <input type="text" className="w-full h-10 bg-gray-300/10 text-gray-300 dark:bg-dark-900 dark:text-white border border-transparent focus:border-blue-700 outline-0 px-3 py-2 font-Mult-Font-Bold text-sm rounded-lg mt-1" placeholder="رمز فعلی را وارد کنید"/>
                    <button className="absolute left-3 top-1/2 rounded-md p-1 text-gray-350 dark:text-gray-810 hover:bg-gray-350/15 transition-all cursor-pointer">
                ...
                <div className="relative">
                    ...
                    <input type="text" className="w-full h-10 bg-gray-300/10 text-gray-300 dark:bg-dark-900 dark:text-white border border-transparent focus:border-blue-700 outline-0 px-3 py-2 font-Mult-Font-Bold text-sm rounded-lg mt-1" placeholder="رمز عبور جدید را وارد کنید"/>
                    <button className="absolute left-3 top-1/2 rounded-md p-1 text-gray-350 dark:text-gray-810 hover:bg-gray-350/15 transition-all cursor-pointer">
                        <DynamicIcon name="eye" className="size-4 text-inherit" />
                    </button>
                </div>
                ...
                <div className="relative">
                    ...
                    <input type="text" className="w-full h-10 bg-gray-300/10 text-gray-300 dark:bg-dark-900 dark:text-white border border-transparent focus:border-blue-700 outline-0 px-3 py-2 font-Mult-Font-Bold text-sm rounded-lg mt-1" placeholder="تکرار رمز جدید را وارد کنید"/>
                    <button className="absolute left-3 top-1/2 rounded-md p-1 text-gray-350 dark:text-gray-810 hover:bg-gray-350/15 transition-all cursor-pointer">
                        <DynamicIcon name="eye" className="size-4 text-inherit" />
                    </button>
                </div>
                ...
                <div className="rounded-xl border border-blue-700 border-opacity-20 bg-blue-700/5 p-4">
                    ...
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        <li className="flex items-center gap-2">
                            <span className="size-4 flex-center rounded-full bg-gray-350/25 text-gray-350 dark:text-gray-810"></span>
                ...
                <button type="button" className="flex-center h-11 px-6 border border-blue-700 bg-blue-700 text-white hover:bg-transparent hover:text-blue-700 transition-all rounded-lg font-YekanBakh-Bold cursor-pointer">ثبت رمز جدید</button>
            </from>
        </div>
    );
}
