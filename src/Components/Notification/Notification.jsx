...
function Notification({title, message, Icon, setIsOpen , isOpen}) {
    ...
    return ReactDOM.createPortal(
        <div className={`w-90 h-20 absolute top-4 right-4 z-20 mx-auto flex items-center gap-x-3 p-3.5 pr-7 rounded-lg bg-gray-200 dark:bg-dark-930 shadow overflow-hidden duration-200 transition-all`}>
            {/* ! ================== ! Notification Icon ! ================== ! */}
