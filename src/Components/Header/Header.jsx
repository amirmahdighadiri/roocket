...
function Header(props) {
    const {theme, setTheme, isOpenMenu, setIsOpenMenu, setIsShowOverlay, isLoggin, userInfo} = useContext(AppContext)
                ...
                <div className="flex items-center justify-between bg-white dark:bg-dark-890 rounded-2xl p-5 sm:px-11 sm:py-9 shadow-whiteShadow">
                    ...
                    <div className="hidden lg:flex w-1/2 items-center gap-x-4 font-YekanBakh-Medium text-xs">
                        ...
                        <div className="flex w-full h-12 items-center gap-x-2.5 py-4 px-3 bg-gray-210 dark:bg-dark-body-100 rounded-xl">
                            ...
                            <input type="text" className="w-full border-none outline-0 dark:text-white dark:placeholder:text-white" placeholder="دنبال چی میگردی ؟"/>
                        </div>
                        {/*<!-- ! -------------------- Change Them Btn -------------------- ! -->*/}
                    ...
                    <div className={`${isLoggin ? 'hidden' : 'lg:flex'} items-center gap-x-1 font-YekanBakh-Medium`}>
                        <Link to="/auth">
                            <button type="button" data-href="login"
                                ...
                                <DynamicIcon name={'login'} className={'w-5.5 h-5.75'}/>
                            </button>
                        </Link>
                        <Link to="/auth">
                            <button type="button" data-href="register"
                                ...
                                <DynamicIcon name={'profile'} className={'w-5.5 h-5.75'}/>
                            </button>
                        </Link>
                    </div>
                    {/*<!-- ! -------------------- The Other Buttons Are Activated When The Users Is Login -------------------- ! -->*/}
                    <div className={`${isLoggin ? 'flex' : 'hidden'} items-center gap-x-4`}>
                        {/*<!-- ! -------------------- Basket Btn -------------------- ! -->*/}
                ...
                <nav id="menu" className={`fixed lg:static top-0 bottom-0 ${isOpenMenu ? 'right-0' : '-right-69'} h-full lg:h-auto w-69 lg:w-[92%] mx-auto bg-white lg:bg-[#CFD3DB] dark:bg-dark-910 lg:dark:bg-dark-body-100 py-5 px-5 lg:px-0 lg:rounded-b-3xl dark:shadow-whiteShadow transition-all z-20 overflow-y-auto lg:overflow-y-visible`}>
                    ...
                    <div className="block lg:hidden">
                        ...
                        <Link to="/" className="flex justify-center mb-5">
                            {/*<!-- ! -------------------- Header Logo In Desktop -------------------- ! -->*/}
                            <svg className="hidden dark:block w-40 h-9" xmlns="http://www.w3.org/2000/svg" id="big-logo-dark" fill="none" viewBox="0 0 203 46">
                                <path fill="#fff"
                        ...
                        <div className="flex lg:hidden flex-col gap-y-5 font-YekanBakh-Medium py-5 border-y border-gray-200 dark:border-border-gray-100/10 mt-5">
                            {/*<!-- ! -------------------- Change Them Btn -------------------- ! -->*/}
                            <div onClick={changeThemeHandler} className="change-them-btn flex items-center gap-x-2">
                                <div className="flex-center w-12 h-12 dark:bg-dark-body-100 dark:hover:bg-[#ECEEEF] bg-[#ECEEEF] hover:bg-dark-body-100 rounded-full transition-all shrink-0 group">
                                    <DynamicIcon name={'sun'}
                                                 className={'block dark:hidden w-6 h-6 text-biscay-700 group-hover:text-gray-920'}/>
                                    <DynamicIcon name={'moon'}
                                                 className={'hidden dark:block w-6 h-6 text-gray-920 group-hover:text-biscay-700 pt-0.5 pr-0.5'}/>
                    ...
                    <ul className="font-YekanBakh-Medium flex flex-col lg:flex-row gap-y-7 lg:items-center lg:justify-center gap-x-10 pt-6 lg:pt-0 pr-2 lg:pr-0">
                        <li className="flex items-center h-6 gap-x-2 text-biscay-700 hover:text-gray-hover-200 dark:text-white dark:hover:text-gray-hover-150 transition-all">
                            <DynamicIcon name={'home'} className={'block lg:hidden w-5 h-5 dark:text-white text-biscay-700'}/>
                            <Link to="/">راکت</Link>
                        </li>
                        <li className={`lg:relative ${isOpenCoursesSubmenu ? 'h-auto' : 'h-6'} text-biscay-700 hover:text-gray-hover-200 dark:text-white dark:hover:text-gray-hover-150 transition-all`}>
                            <div onClick={toggleCoursesSubmenu} id="courses-submenu-btn" className="flex items-center gap-x-2">
                                <DynamicIcon name={'play'} className={`block lg:hidden w-5 h-5 dark:text-white text-biscay-700`}/>
                                <button type={"button"} id="courses-btn" className="flex items-center gap-x-2 cursor-pointer">
                                    دوره های آموزشی
                            ...
                            <div className={`${isOpenCoursesSubmenu ? 'opened' : 'closed'} w-auto lg:w-119 lg:absolute lg:-right-2 lg:top-14 bg-white dark:bg-dark-890 lg:dark:bg-dark-body-100 rounded-lg pt-2 lg:pt-5 lg:p-5 mt-2.5 lg:mt-0 z-20 transition-all origin-[50%-0px]`}>
                                {/*<!-- ! -------------------- Courses Items Wrapper -------------------- ! -->*/}
                                <div className="grid grid-cols-12">
                                    <div className="col-span-12 lg:col-span-6">
                                        <Link to="/products-page" className="flex items-start gap-x-2 pt-4 px-2 pb-2 hover:bg-gray-hover-100 dark:hover:bg-dark-950 lg:dark:hover:bg-drak-890 rounded-md transition-all">
                                ...
                                {/*<!-- ! -------------------- Popular Courses -------------------- ! -->*/}
                                <div className="w-full bg-[#F7F8F9] dark:bg-dark-950 lg:dark:bg-drak-890 rounded-lg pl-1 pr-3 lg:px-4 py-4 mt-4">
                                    <div className="relative">
                        ...
                        <li className={`lg:relative ${isOpenUsefullSubmenu ? 'h-auto' : 'h-6'}  text-biscay-700 hover:text-gray-hover-200 dark:text-white dark:hover:text-gray-hover-150 transition-all`}>
                            <div onClick={toggleUsefullSubmenu} id="usefull-submenu-btn" className="flex items-center gap-x-2">
                                <DynamicIcon name={'link'}
                                             className={'block lg:hidden w-5 h-5 dark:text-white text-biscay-700'}/>
                                {/*<!-- ! -------------------- Usefull Item Sub Menu =>( remove closed class and add opened class to show submenu) -------------------- ! -->*/}
                                <button type={"button"} id="useful-link-btn" className="flex items-center gap-x-2 cursor-pointer">
                                    لینک های مفید
                                    <DynamicIcon name={'arrowDown'}
                            ...
                            <div id="useful-link-submenu" className={`${isOpenUsefullSubmenu ? 'opened' : 'closed'} w-full lg:w-52 lg:absolute lg:-right-2 lg:top-14 bg-white dark:bg-dark-890 lg:dark:bg-dark-body-100 p-3 mt-2.5 lg:mt-0 pt-2.5 rounded-lg z-20 transition-all origin-[50%-0px]`}>
