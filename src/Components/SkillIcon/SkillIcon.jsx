...
function SkillIcon({name,skillId , iconSrc}) {
    return (
        <div className="relative inline-flex flex-col items-center group cursor-pointer *:transition-all *:duration-400">
            <a href={`#${skillId}`} className="relative flex-center size-25 bg-gray-5 rounded-md lg:grayscale lg:group-hover:filter-none lg:group-hover:-translate-y-5">
